...
class FacebookScrapper:
    ...
    DB_POST_ATRIBUTES = ["id", "fb_id", "message", "likes_count", "love_count",
                         "wow_count", "haha_count", "sad_count", "angry_count",
                         "thankful_count", "time_created", "shares",
                         "fanpagelink", "type", "link", "name", "description",
                         "external_picture", "num_comments", "page_id"]
    DB_COMMENT_ATRIBUTES = ["id", "fb_id", "message", "likes_count",
    ...
    def render_to_json(self, json_url):
        ...
        while tries <= 20:
            try:
                web_response = urllib2.urlopen(json_url, timeout=30)
        ...
        key = raw_input("Probably the number of requests was exceeded, "
    ...
    def scrape_posts_by_date(self, post_url, date, posts, company,
        ...
        try:
            ...
            for post in page_posts:
                ...
                love_count = counter["love"]
                wow_count = counter["wow"]
                haha_count = counter["haha"]
                sad_count = counter["sad"]
                angry_count = counter["angry"]
                thankful_count = counter["thankful"]
                ...
                current_post = [fb_post_id, message, likes_count, love_count,
                                wow_count, haha_count, sad_count, angry_count,
                                thankful_count, time_created, shares,
